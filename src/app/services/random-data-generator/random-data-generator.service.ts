...
import { Fine, FineAmount, FineTemplate, FineTemplateRepetition, MoneyAmount, Person, PersonProperties, Team } from '@stevenkellner/team-conduct-api';
...
export class RandomDataGeneratorService {
    ...
    private async createTestPersons(teamId: Team.Id, personId: Person.Id): Promise<Person.Id[]> {
        ...
        //         teamId: teamId,
        //         id: personId,
        //         properties: new PersonProperties(`Test${i}`, 'Person')
        //     });
        // }));
        return personIds;
    }
